...
public class ViewPager extends android.support.v4.view.ViewPager implements GestureDetector.OnGestureListener {
	...
	// be in a real drag when we want to initialize the fake drag.
	@Override
...
*/	    }
	...
	private void endFlingMotion() {
	    mScrolling = false;
	    this.endFakeDrag(); //this causes a snap back.
	}
