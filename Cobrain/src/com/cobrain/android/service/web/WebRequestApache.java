...
public class WebRequestApache extends AsyncTask<Void, Void, Integer> {
	private static final int GET = 0;
	private static final int POST = 1;
	private static final int PUT = 2;
	private static final int DELETE = 3;
	private static final String TAG = "WebRequestApache";
	...
	public WebRequestApache post(String url) {
		this.url = url;
		this.action = POST;
		return this;
	}
	public WebRequestApache get(String url) {
		this.url = url;
		this.action = GET;
		return this;
	}
	public WebRequestApache put(String url) {
		this.url = url;
		this.action = PUT;
		return this;
	}
	public WebRequestApache delete(String url) {
		this.url = url;
		this.action = DELETE;
		return this;
	}
	
    public WebRequestApache setFormFields(HashMap<String, String> formFields) {
		this.formFields = formFields;
    	return this;
    }
    public WebRequestApache setHeaders(HashMap<String, String> headers) {
		this.headerFields = headers;
    	return this;
    }
	public WebRequestApache setContentType(String type) {
		contentType = type;
		return this;
	}
    
    public WebRequestApache setOnResponseListener(OnResponseListener listener) {
    	responseListener = listener;
    	return this;
    }

	public WebRequestApache setBody(String query) {
		body = query;
		return this;
	}

	public WebRequestApache setTimeout(int timeout) {
