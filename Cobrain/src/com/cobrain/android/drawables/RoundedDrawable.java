...
public class RoundedDrawable extends Drawable {
  ...
  public static int DEFAULT_DRAWABLE_SIZE = 100;
    ...
    if (drawable != null) {
      if (drawable instanceof RoundedDrawable) {
        ...
        return drawable;
    	  ...
    	  if (r.width() == 0) r.right = DEFAULT_DRAWABLE_SIZE;
    	  if (r.height() == 0) r.bottom = DEFAULT_DRAWABLE_SIZE;
  ...
  public static Bitmap drawableToBitmap(Drawable drawable) {
    ...
    if (width == -1) width = drawable.getBounds().width();
    if (height == -1) height = drawable.getBounds().width();
    if (width > 0 && height > 0) {
